...
const CtaSection: React.FC = () => {
  ...
  return (
    <section id="contact" className="relative overflow-hidden bg-gradient-to-br from-blue-900 via-blue-800 to-blue-900">
      ...
      {/* Floating elements */}
      <div className="absolute top-20 left-20 w-32 h-32 bg-blue-500 rounded-full blur-[60px] opacity-20" />
      <div className="absolute bottom-20 right-20 w-40 h-40 bg-blue-400 rounded-full blur-[80px] opacity-15" />

      <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-16 sm:py-20 lg:py-24 text-center">
        {/* Pre-heading badge */}
        <div className="inline-flex items-center gap-2 bg-blue-500/10 border border-blue-500/20 text-blue-300 px-3 sm:px-4 py-1.5 sm:py-2 rounded-full text-xs sm:text-sm font-semibold mb-4 sm:mb-6">
          <span>🚀</span>
          Limited Time Offer
        </div>
        ...
        <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-black tracking-tight text-white mb-4 sm:mb-6">
          Ready to Take the <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-blue-500">Leap?</span>
        </h2>

        {/* Enhanced sub text */}
        <p className="mx-auto mt-4 sm:mt-6 max-w-3xl text-lg sm:text-xl text-gray-300 leading-relaxed mb-6 sm:mb-8 px-4">
          Join <strong className="text-blue-400">15,000+ successful students</strong> who've transformed their lives through our expert guidance.
          Book your <strong className="text-blue-400">FREE consultation</strong> today and discover your path to global success.
        </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 sm:gap-6 lg:gap-8 max-w-4xl mx-auto mb-6 sm:mb-8">
          <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-xl sm:rounded-2xl p-4 sm:p-6">
            <div className="text-2xl sm:text-3xl font-bold text-blue-400 mb-1 sm:mb-2">FREE</div>
        ...
        <div className="flex flex-col items-center justify-center gap-4 sm:gap-6 sm:flex-row">
          <button
            onClick={openModal}
            className="group bg-blue-600 text-white px-6 sm:px-8 lg:px-10 py-3 sm:py-4 text-base sm:text-lg font-semibold rounded-full items-center gap-2 sm:gap-3 flex hover:bg-blue-700 transition-all duration-300 transform hover:scale-105 shadow-lg"
          >
