      ...
      <div className="hidden bg-primary text-white lg:block">
        <div className="mx-auto flex max-w-7xl items-center justify-between px-8 py-2.5 text-[13px]">
          <div className="flex items-center gap-8">
            <a href={`tel:${phones.primaryRaw}`} className="flex items-center gap-2 hover:text-secondary transition-colors"><Phone size={14} /><span>{phones.primary}</span></a>
            <a href={`mailto:${emails.info}`} className="flex items-center gap-2 hover:text-secondary transition-colors"><Mail size={14} /><span>{emails.info}</span></a>
          </div>
          ...
          <div className="flex h-20 items-center justify-between">
            ...
            <nav className="hidden lg:flex items-center space-x-1">
              {navItems.map((item) => (
                ...
                >
                  <Link href={item.href} className={`px-4 py-2.5 text-[15px] font-bold rounded-xl flex items-center gap-1.5 transition-all ${isActive(item.href) ? "text-primary bg-blue-50" : "text-slate-700 hover:text-primary hover:bg-slate-50"}`}>
                    {item.name}
