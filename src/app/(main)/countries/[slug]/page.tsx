      ...
      <div className="min-h-screen bg-[#FAFAFA]">
        <div className="mx-auto max-w-7xl px-6 py-12">
          <div className="animate-pulse rounded-[2.5rem] border border-slate-200 bg-white p-8 shadow-sm">
            ...
            <div className="mt-6 h-16 w-full max-w-2xl rounded-3xl bg-slate-100" />
            <div className="mt-4 h-6 w-full max-w-3xl rounded-full bg-slate-100" />
            <div className="mt-10 grid gap-4 md:grid-cols-4">
              {Array.from({ length: 4 }).map((_, index) => (
                <div key={index} className="h-32 rounded-[1.75rem] bg-slate-100" />
              ))}
            </div>
          </div>
        </div>
